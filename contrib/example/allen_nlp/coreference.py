...
import tools.common_methods as cm
...
class Coreference:
    ...
    def order_coref_on_avo_index(
        ...
        for reference_result in coref_results:
            ...
            possible_ranges = [
                range(avo["begin_index"], avo["end_index"] + 1) for avo in possible_avos
            ]
            found_avo_indices = [
                index
            ...
            avo_sent_indices = [
                avo_sents.index(possible_avos[avo_id]) for avo_id in found_avo_indices
            ]
