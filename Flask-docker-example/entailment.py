...
class Entailment(AllenNLPinterface):
    ...
    def __init__(self) -> None:
        """Init class."""
        AllenNLPinterface.__init__(self, "http://allen_abgs:5000/predict/snliadv/load")
    ...
    def entailment(self, premise: str, hypothesis: str):
        ...
        """
        input_obj = self.create_input_dict(premise, hypothesis)
        if not self.connect(input_obj):
            return []
